...
export class VideoHandler extends UploadHandler {
	...
	public async processAttachment(file: PostFileData, fields: PostFields): Promise<IMessage | null> {
		// Only wait for the message creation in the database.
		await this.sendConversionMessage();

		// Start the conversion task, but don't wait on it!
		...
		// Return the conversion message generated by sendConversionMessage.
		return this.getConversionMessage() ?? null;
	}
